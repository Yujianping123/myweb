...
def base(req):
	pass
	return render(req,'assets/base.html')


def index(req):
	asset = Asset.objects.all()
	return render(req,'assets/index.html', locals())


def dashboard(req):
	pass
	return render(req,'assets/dashboard.html', locals())


def detail(req, asset_id):
    """
    ...
    return render(req, 'assets/detail.html', locals())
